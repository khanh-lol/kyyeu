document.addEventListener('DOMContentLoaded', () => {
    ...
    const members = [
        { name: 'Minh Vũ', nickname: 'Peace', quote: 'Thanh xuân như một tách trà...', img: 'style/img/ThanhVien/MinhVu.jpg', hobbies: 'Chụp ảnh, du lịch', message: 'Mãi là bạn thân nhé!' },
        { name: 'Tuấn Nam', nickname: 'Lụm', quote: 'Học không chơi đánh rơi tuổi trẻ.', img: 'style/img/ThanhVien/TuanNam.jpg', hobbies: 'Cafe, nghe nhạc', message: 'Hẹn gặp lại ở đại học.' },
